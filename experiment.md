...
| 43 |  global   | Transformer_E  | longitude | -23hr~0hr |  4hr   |   1.444    |   12, 128   | min-max, no  |
...
| 46 |  global   | Transformer_E  | longitude | -23hr~0hr |  1hr   |   0.545    |   12, 128   |     None     |
| 47 |  global   | Transformer_E  | longitude | -47hr~0hr |  1hr   |   68.675   |   12, 128   |     None     |
| 48 |  global   | Transformer_E  | longitude | -47hr~0hr |  1hr   |   0.643    |   12, 128   | min-max, no  |
| 49 |  global   | Transformer_E  | longitude | -11hr~0hr |  1hr   |   0.558    |   12, 128   |     None     |
| 50 |  global   | Transformer_E  | longitude | -3hr~0hr  |  1hr   |   0.558    |   12, 128   |     None     |
| 51 |  global   | Transformer_E  | longitude | -47hr~0hr |  1hr   |   0.662    |   6, 128    |     None     |
| 52 |  global   | Transformer_E  | longitude | -23hr~0hr |  1hr   |   1.117    |   6, 128    |     None     |
| 53 |  global   | Transformer_E  | longitude | -11hr~0hr |  1hr   |   0.944    |   6, 128    |     None     |
| 54 |  global   | Transformer_E  | longitude | -3hr~0hr  |  1hr   |   0.549    |   6, 128    |     None     |
| 55 |  global   | Transformer_E  | longitude | -47hr~0hr |  1hr   |   8.152    |   24, 128   |     None     |
| 56 |  global   | Transformer_E  | longitude | -47hr~0hr |  1hr   |   0.682    |   24, 128   | min-max, no  |
| 57 |  global   | Transformer_E  | longitude | -23hr~0hr |  1hr   |   0.553    |   24, 128   |     None     |
| 58 |  global   | Transformer_E  | longitude | -11hr~0hr |  1hr   |   0.891    |   24, 128   |     None     |
| 59 |  global   | Transformer_E  | longitude | -3hr~0hr  |  1hr   |   0.537    |   24, 128   |     None     |
...
| 63 |  global   | Transformer_E  |   time    | -23hr~0hr |  6hr   |   1.616    |   12, 128   | min-max, no  |
...
| 71 |  global   | Transformer_E  | longitude | -23hr~0hr |  2hr   |   0.967    |   12, 128   |     None     |
| 72 |  global   | Transformer_E  | longitude | -23hr~0hr |  3hr   |   1.315    |   12, 128   | min-max, no  |
| 73 |  global   | Transformer_E  | longitude | -23hr~0hr |  6hr   |   1.581    |   12, 128   | min-max, no  |
| 74 |  global   | Transformer_E  | longitude | -23hr~0hr |  12hr  |   1.692    |   12, 128   | min-max, no  |
| 75 |  global   | Transformer_E  | longitude | -23hr~0hr |  24hr  |   1.801    |   12, 128   | min-max, no  |
| 76 |  global   | Transformer_E  | longitude | -47hr~0hr |  4hr   |   1.767    |   12, 128   | min-max, no  |
| 77 |  global   | Transformer_E  | longitude | -11hr~0hr |  4hr   |   2.250    |   12, 128   | min-max, no  |
| 78 |  global   | Transformer_E  | longitude | -3hr~0hr  |  4hr   |   2.307    |   12, 128   | min-max, no  |
| 79 |  global   | Transformer_E  | latitude  | -3hr~0hr  |  4hr   |   2.775    |   12, 128   | min-max, no  |
| 80 |  global   | Transformer_E  | longitude | -47hr~0hr |  4hr   |   1.644    |   12, 256   | min-max, no  |
| 81 |  global   | Transformer_E  | longitude | -23hr~0hr |  4hr   |   1.809    |   12, 256   | min-max, no  |
| 82 |  global   | Transformer_E  | longitude | -11hr~0hr |  4hr   |   2.029    |   12, 256   | min-max, no  |
| 83 |  global   | Transformer_E  | longitude | -3hr~0hr  |  4hr   |   2.096    |   12, 256   | min-max, no  |
| 84 |  global   | Transformer_E  |   time    | -23hr~0hr |  48hr  |   4.011    |   12, 128   | min-max, no  |
| 85 |  global   | Transformer_E  | latitude  | -23hr~0hr |  48hr  |   2.632    |   12, 128   | min-max, no  |
| 86 |  global   | Transformer_E  | longitude | -23hr~0hr |  48hr  |   3.341    |   12, 128   | min-max, no  |
| 87 |  global   | Transformer_ED |   time    | -23hr~0hr |  4hr   |   2.746    |   6, 256    | min-max, no  |
